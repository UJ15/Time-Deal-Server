...
public interface OrderRepository extends JpaRepository<Order, UUID> {
    ...
    @Query("select o from Order o inner join fetch o.user where o.user.id = :userId")
    List<Order> findByUserId(UUID userId);

    @Query("select o from Order o inner join fetch o.product where o.product.id = :productId")
